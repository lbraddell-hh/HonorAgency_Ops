...
- **Concept**: a warm desk lantern / lighthouse-beacon character — the light
  that's always on at the front door. Authority expressed as steadiness and
  glow, not size or sharpness.
- **Body**: HonorHealth Purple `#72226d` squircle-lantern with softly rounded
  shoulders; a gold `#ffb81d` light-core that doubles as the face.
- **Face**: the gold core carries two crescent light-glints as eyes; "smiling"
